...
public class Message
{
    ...
    public const string ComparisonMaxCount = "بیشتر از 3 ایتم برای مقایسه نمی توانید انتخاب کنید";
    ...
    public const string DuplicateEconomicCode = "کد اقتصادی تکراری است";
    ...
    public const string DuplicateComparisonItem = "این ایتم در لیست وجود دارد";
    ...
    public const string IsExistToFavorite = "در لیست علاقه مندی ها وجود دارد";
    public const string UserFinanceIdNotFound = "اطلاعات پرداخت این فاکتور در سامانه داخلی یافت نشد";
